...
class BaseTable extends React.PureComponent {
  ...
  renderRow({ isScrolling, columns, rowData, rowIndex, style }) {
    ...
    const className =clsx(this._prefixClass('row'), rowClass, {
  ...
  renderRowCell({ isScrolling, columns, column, columnIndex, rowData, rowIndex, expandIcon }) {
    ...
    const cls = clsx(this._prefixClass('row-cell'), cellCls, {
  ...
  renderHeader({ columns, headerIndex, style }) {
    ...
    const className = clsx(this._prefixClass('header-row'), headerClass, {
  ...
  renderHeaderCell({ columns, column, columnIndex, headerIndex, expandIcon }) {
    ...
    const cls = clsx(this._prefixClass('header-cell'), cellCls, {
    ...
    return (
      ...
      >
        ...
        {column.sortable && (
          <SortIndicator
            sortOrder={sortOrder}
            className={clsx(this._prefixClass('sort-indicator'), {
  ...
  render() {
    ...
    const cls = clsx(classPrefix, className, {
